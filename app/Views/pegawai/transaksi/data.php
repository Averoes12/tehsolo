                        ...
                        <tr>
                            ...
                            <td align="right">
                                <?php if ($row['type'] == "in" && $row['cancelInd'] == "N") { ?>
                                    ...
                                    <a href="<?= base_url('pegawai/transaksi/generate/' . $row['id']) ?>" class="btn btn-warning" data-toggle="tooltip" data-placement="top" data-title="Cetak Transaksi"><i class="fas fa-print "></i></a>
                                <?php } ?>
                                <?php if ($row['type'] == "out") { ?>
                                    <a href="<?= base_url('pegawai/transaksi/editPengeluaran/' . $data) ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" data-title="Edit Transaksi"> <i class="fas fa-edit"></i></a>
                                <?php } ?>
                                <?php if ($row['type'] == "in") { ?>
