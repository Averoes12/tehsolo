                        ...
                        <tr>
                            ...
                            <td align="right">
                                <?php if ($row['type'] == "in" && $row['cancelInd'] == "N") { ?>
                                    ...
                                    <a href="<?= base_url('pegawai/transaksi/generate/' . $row['id']) ?>" class="btn btn-warning"
                                        data-toggle="tooltip" data-placement="top" data-title="Cetak Transaksi"><i
                                            class="fas fa-print "></i></a>
                                <?php } ?>
                                <?php if ($row['type'] == "out") { ?>
                                    <a href="<?= base_url('pegawai/transaksi/editPengeluaran/' . $data) ?>"
    ...
    for (let index = 1; index <= total; index++) {
        ...
        $(`#btn-cancel-trx-${index}`).click(function () {
            ...
            Swal.fire({
                ...
                if (resp.value) {
                    $.ajax({
                        url: `<?= base_url('pegawai/transaksi/cancelTrx') ?>/${id}`,
                        success: function (response) {
        ...
        $(`#btn-dtl-trx-${index}`).click(function () {
            ...
            $.ajax({
                url: `<?= base_url('pegawai/transaksi/getDetailTransaksi') ?>/${id}`,
                success(resp) {
                    $("#list-menu-dtl").html("");
