            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td align="right">
                                <a href="<?= $row['type'] == "in" ?  base_url('owner/transaksi/edit/' . $data) : base_url('owner/transaksi/editPengeluaran/' . $data) ?>" class="btn btn-primary btn-sm"> <i class="fas fa-edit"></i></a>
                            </td>
                        </tr>
                    <?php endforeach;
                } else { ?>
